...
public class SoundtrackToLife {
	...
	public static void main(String[] args) {
		...
		int userMood = JOptionPane.showOptionDialog(null, "What mood are you in?", "Mood Quiz", 0,
				JOptionPane.INFORMATION_MESSAGE, null, new String[] { "Stressed", "Chill", "Hyped" }, null);
		...
		if (userMood == 0) {
			playVideo("https://www.youtube.com/watch?v=0EWbonj7f18");
			if (userMood == 1) {
				playVideo("https://www.youtube.com/watch?v=IrV90gXmOpA");
			}
		}
